          ...
          <SwiperSlide>
            <div className="w-9/12 mx-auto lg:flex ">
              <p className="w-9/12 p-2 text-3xl font-medium text-center text-black">
                Cooks plan, organize, prepare and cook meals, according to
                recipes or under the supervision of chefs, in hotels,
                restaurants and other eating places, on board ships, on
