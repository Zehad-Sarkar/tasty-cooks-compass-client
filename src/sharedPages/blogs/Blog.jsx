...
const Blog = () => {
  ...
  const handleDownload = () => {
    ...
    // Create a new PDF file with the blog title as its name
    const pdfDoc = new jsPDF();
    pdfDoc.text(blogTitle, 10, 10);
    pdfDoc.save(`${blogTitle}.pdf`);
  };

  return (
    <div className="m-16">
      <Button onClick={handleDownload} className="absolute top-20 right-2 btn">
        DownLoad Pdf
      </Button>
      <div className="">
